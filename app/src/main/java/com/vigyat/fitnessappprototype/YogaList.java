...
import com.vigyat.fitnessappprototype.decoration.YogaListDecoration;
...
public class YogaList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int spacingInPixels = getResources().getDimensionPixelSize(R.dimen.yoga_list_spacing);
        yogaListBinding.yogaRecyclerView.addItemDecoration(new YogaListDecoration(spacingInPixels));
